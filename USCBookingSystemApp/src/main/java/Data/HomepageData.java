...
public class HomepageData {
    ...
    public ArrayList<Lesson> yogaLessons = listofYogaLessons();
    public ArrayList<Booking> bookings = listOfBookings();
    public ArrayList<Lesson> bodyblitzLessons = listofBodyBlitzLessons();
    ...
    public ArrayList<Lesson> sundayLessons = listofSundayLessons();
    public ArrayList<Lesson> saturdayLessons = listOfSaturdayLessons();
    public ArrayList<Booking> bookingBoxFit = new ArrayList<Booking>();
    public ArrayList<Lesson> boxfitLessons = listofBoxFitLessons();
    public ArrayList<Students> student = listOfStudents();
    public ArrayList<Lesson> zumbaLessons = listofZumbaLessons();
    public ArrayList<Lesson> allLessons = listofAllLessons();
